		...
		while (true) {
			...
			if (str.length() == 1) {
				...
				if (str.equals("Q")) {
					...
					System.out.println((int)total+" dogs, A:"+String.format("%.1f",sumAge/total)+", W:"+String.format("%.1f",sumWeight/total));
					System.out.println("----------");
				} else if (str.equals("C")) {
					total = (double)cats.size();
                                          sumAge = 0;
                                        sumWeight = 0;
					for (Cat c : cats) {
						c.print();
					...
					System.out.println((int)total+" cats, A:"+String.format("%.1f",sumAge/total)+", W:"+String.format("%.1f",sumWeight/total));
					System.out.println("----------");
				}
